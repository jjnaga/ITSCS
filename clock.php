        ...
        <div id="timesheets">
          ...
          <div id="timesheetcards">
            ...
            <div class="footercard" id="historycard">
              ...
              <div id="showTInputs">
                <input type="text" name="date" placeholder="Since: mm/dd/yyyy" pattern="[0-9]{2}/[0-9]{2}/[0-9]{4}" title="Enter as: mm/dd/yyyy" maxlength=10>
                <select name="ctype">
            ...
            <div class="footercard" id="tcard">
              ...
              <input id="printinput" name="date" type="text" placeholder="mm/dd/yyyy" pattern="[0-9]{2}/[0-9]{2}/[0-9]{4}" title="Enter as: mm/dd/yyyy" maxlength=10>
