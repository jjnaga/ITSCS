...
//Note: Admin page will be able to specify username explicitly.
$date = $_POST["date"];
...
calc_initial_vars($chosen_day, $chosen_month, $chosen_year, $period_start_day, $period_start_month, $period_start_year, 
...
$week1 = calc_week($chosen_user, $week_start_day, $week_start_month, $week_start_year, 
                   $period_end_day, $period_end_month, $period_end_year, 
				   $period_start_day, $period_start_month, $period_start_year);
$week1["start_day"] = mktime(0, 0, 0, $week_start_month, $week_start_day, $week_start_year);

$week2 = calc_week($chosen_user, $week_start_day, $week_start_month, $week_start_year, 
                   $period_end_day, $period_end_month, $period_end_year, 
				   $period_start_day, $period_start_month, $period_start_year);
$week2["start_day"] = mktime(0, 0, 0, $week_start_month, $week_start_day, $week_start_year);

$week3 = calc_week($chosen_user, $week_start_day, $week_start_month, $week_start_year, 
                   $period_end_day, $period_end_month, $period_end_year, 
				   $period_start_day, $period_start_month, $period_start_year);
...
if($week_start_sunday["day"] == $period_start_day && $week_start_sunday["month"] == $period_start_month && $week_start_sunday["year"] == $period_start_year) {
  ...
  $partial_week = calc_week($chosen_user, $week_start_sunday["day"], $week_start_sunday["month"], $week_start_sunday["year"],
                            $period_start_day - 1, $period_start_month, $period_start_year,
						    $week_start_sunday["day"], $week_start_sunday["month"], $week_start_sunday["year"]);
  ...
  $partial_week["partial_week_hours_parsed"] = sprintf("%u:%02u", ($partial_week["partial_week_mins"] - $partial_week["partial_week_mins"]%60)/60,
